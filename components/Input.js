...
function Input() {
  ...
  const sendPost = async () => {
    ...
    setLoading(false);
    setInput("");
    setSelectedFile(null); //agar ssetelah di upload, image dikosongin
    setShowEmojis(false); //emoji juga di kosongin
  };
  ...
  return (
    // overflow-y-scroll, agar saat nulis tweet bisa di scroll
